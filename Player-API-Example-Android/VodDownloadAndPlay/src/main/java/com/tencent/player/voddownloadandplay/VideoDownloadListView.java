package com.tencent.player.voddownloadandplay;
...
import com.tencent.player.DialogUtils;
import com.tencent.player.entity.VideoModel;
import com.tencent.player.voddownloadandplay.adapter.VideoDownloadListAdapter;
...
public class VideoDownloadListView extends RelativeLayout
    ...
    public void addCacheVideo(List<TXVodDownloadMediaInfo> mediaInfoList, boolean isNeedClean) {
        ...
        Log.i("tomgui","addCacheVideo" + mediaInfoList.size());
        ((Activity)mContext).runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mVideoDownloadListAdapter.notifyItemRangeInserted(oldLength, mMediaInfoList.size());
                checkIfShowEmptyView();
            }
        });
    }
