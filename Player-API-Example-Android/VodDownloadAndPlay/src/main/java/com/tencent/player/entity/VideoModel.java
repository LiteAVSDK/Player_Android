package com.tencent.player.entity;



import static com.tencent.player.entity.SuperPlayerModel.PLAY_ACTION_AUTO_PLAY;
        ...
        if (!TextUtils.isEmpty(videoURL)) {
            if (isSuperPlayerVideo()) {
                ...
                if (multiVideoURLs != null) {
                    for (VideoPlayerURL modelURL : multiVideoURLs) {
