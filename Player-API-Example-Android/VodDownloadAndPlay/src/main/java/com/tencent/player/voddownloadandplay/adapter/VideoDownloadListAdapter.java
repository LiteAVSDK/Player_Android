package com.tencent.player.voddownloadandplay.adapter;
...
import com.tencent.player.voddownloadandplay.VideoDownloadItemView;
    ...
    public VideoDownloadViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (null == mVideoDownloadHelper) {
            mVideoDownloadHelper =
                    new VideoDownloadHelper(parent.getContext().getString(R.string.superplayer_cache_progress),parent.getContext());
        }
