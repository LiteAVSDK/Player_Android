...
public class VideoDownloadCenter {
    ...
    public void setOnDownloadStartListener(OnDownloadStartListener listener) {
        mOnDownloadStartListener = listener;
    }
    ...
    class CacheCenterDownloadListener implements ITXVodDownloadListener {
        ...
        public void onDownloadStart(TXVodDownloadMediaInfo txVodDownloadMediaInfo) {
            ...
            mOnDownloadStartListener.onDownloadStart(txVodDownloadMediaInfo);
        }
