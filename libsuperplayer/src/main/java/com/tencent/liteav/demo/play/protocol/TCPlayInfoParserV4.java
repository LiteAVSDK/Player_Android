...
public class TCPlayInfoParserV4 implements IPlayInfoParser {
    ...
    private void parsePlayInfo() {
        try {
//            JSONObject player = mResponse.getJSONObject("player");
//            if (player != null) {
//                JSONArray resolutionNames = player.getJSONArray("resolutionNames");
//                if (resolutionNames != null && resolutionNames.length() > 0) {
//                    mResolutionNameList = new ArrayList<>();
//                    for (int i = 0; i < resolutionNames.length(); i++) {
//                        JSONObject jsonObject = resolutionNames.getJSONObject(i);
//                        TCResolutionName resolutionName = new TCResolutionName();
//                        resolutionName.minEdgeLength = jsonObject.getInt("minEdgeLength");
//                        resolutionName.name = jsonObject.getString("name");
//                        mResolutionNameList.add(resolutionName);
//                    }
//                }
//            }
