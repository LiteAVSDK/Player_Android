...
import com.tencent.liteav.demo.common.custom.customcapture.AudioFrameReader.AudioFrameReadListener;
import com.tencent.liteav.demo.common.custom.customcapture.VideoFrameReader.VideoFrameReadListener;
...
public class CustomCaptureVideo {
    private static final String           TAG             = "CustomCaptureVideo";
    ...
    public synchronized void start(AudioFrameReadListener audioListener, VideoFrameReadListener videoListener) {
        ...
        try {
            ...
            Toast.makeText(mContext, "failed to open file!", Toast.LENGTH_LONG).show();
            return;
        }
