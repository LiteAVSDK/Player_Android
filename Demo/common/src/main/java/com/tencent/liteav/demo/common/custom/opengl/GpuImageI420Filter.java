...
public class GpuImageI420Filter extends GPUImageFilter {
    ...
    private static final String I420_RENDER_SHADE = ""
            ...
            + "    yuvColor.z = texture2D(uTexture, vec2(textureCoordinate.x * 0.5, textureCoordinate.y * 0.5 + 0.5))"
            + ".r;\n"
            + "\n"
    ...
    public void loadYuvDataToTexture(byte[] yuvData, int width, int height) {
        ...
        mUvTextureId = OpenGlUtils
                .loadTexture(GLES20.GL_LUMINANCE, ByteBuffer.wrap(mUvData), width, height / 2, mUvTextureId);
    }
